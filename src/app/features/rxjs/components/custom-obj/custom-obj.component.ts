...
@Component({
  selector: 'app-custom-obj',
  templateUrl: './custom-obj.component.html',
  styleUrls: ['./custom-obj.component.scss'],
})
export class CustomObjComponent {
  techStatus: any;
  techStatus2: any;
  ...
  setIntervalExp() {
    ...
    this.subscriptionPro = obs2.subscribe(
      (response: any) => {
